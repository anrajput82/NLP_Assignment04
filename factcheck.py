...
# Add these imports for word overlap
import nltk
...
class WordRecallThresholdFactChecker(FactChecker):
    ...
    def preprocess(self, text):
        ...
        return set([t for t in tokens if t.isalpha() and t not in self.stopwords])
    ...
    def predict(self, fact: str, passages: List[dict]) -> str:
        ...
        for passage in passages:
            ...
            recall = len(overlap) / len(fact_words) if fact_words else 0
